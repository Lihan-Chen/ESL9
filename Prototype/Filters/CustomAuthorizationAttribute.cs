...
{
    public class CustomAuthorizationAttribute : AuthorizeAttribute, IAsyncAuthorizationFilter //(ICoreService coreService)
    {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            string? userID = "U06337"; // _coreService.GetEmployeeIDByEmployeeName(user.Identity.Name);
            ...
            string? userRole = "ESL_SUPERADMIN"; // await _coreService.GetRole(userID, facilNo); 
